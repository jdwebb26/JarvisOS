...
**Quant lane channels** (pulse) have outbound webhooks and gateway allowlist entries, but their inbound binding routes to **jarvis as a temporary fallback**. Fish, Atlas, and Sigma have been promoted to full agents with their own bindings and identities (see agent_roster.md).
