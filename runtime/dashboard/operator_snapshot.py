...
def build_operator_snapshot(root: Path) -> dict:
    ...
    snapshot = {
        ...
        "security_validation_summary": status.get("security_validation_summary", {}),
        "prompt_caching_policy_summary": status.get("prompt_caching_policy_summary", {}),
        "mcp_policy_summary": status.get("mcp_policy_summary", {}),
