...
def build_operator_snapshot(root: Path) -> dict:
    ...
    snapshot = {
        ...
        "local_model_lane_proof_summary": status.get("local_model_lane_proof_summary", {}),
        "workspace_registry_summary": status.get("workspace_registry_summary", {}),
        "world_ops_summary": status.get("world_ops_summary", {}),
        "shadowbroker_summary": status.get("shadowbroker_summary", {}),
        "adaptation_lab_summary": status.get("adaptation_lab_summary", {}),
        "optimizer_summary": status.get("optimizer_summary", {}),
        ...
        "openclaw_discord_session_summary": status.get("openclaw_discord_session_summary", {}),
